...
public class FriendController {
    ...
    @PostMapping("{id}/{id2}")
    public void addFriend(@PathVariable("id") String id1, @PathVariable("id2") String id2) {
        service.addFriend(new FriendRequest(id1, id2));
    }

    @DeleteMapping("{id}/{id2}")
    public void deleteFriend(@PathVariable("id") String id1, @PathVariable("id2") String id2) {
